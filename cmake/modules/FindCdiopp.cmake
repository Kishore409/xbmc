...
if(ENABLE_INTERNAL_CDIO)
  ...
  if(CDIOPP_INCLUDE_DIR AND CDIOPP_LIBRARY AND ISO9660PP_INCLUDE_DIR AND ISO9660PP_LIBRARY AND
     CDIO_INCLUDE_DIR AND CDIO_LIBRARY AND ISO9660_INCLUDE_DIR AND ISO9660_LIBRARY)
    set(CDIOPP_FOUND TRUE)
  endif()
